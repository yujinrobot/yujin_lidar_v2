add_definitions(-DENABLE_CV_HELPERS=0)
add_definitions(-DARM_ONBOARD_BUILDING=0)
SET (ARM_ONBOARD_BUILDING FALSE)

SET (PLAIN_LINUX_BOX TRUE)
...
set(TOOLCHAIN_TUPLE "arm-openwrt-linux" CACHE STRING "Toolchain signature identifying cpu-vendor-platform-clibrary.")
set(TOOLCHAIN_ROOT "/home/jakan2/Downloads/gcc-openwrt-r16/linux-x86/arm/toolchain-sunxi/toolchain" CACHE STRING "Root of the installed toolchain")
set(TOOLCHAIN_SYSROOT "/home/jakan2/Downloads/gcc-openwrt-r16/linux-x86/arm/toolchain-sunxi/toolchain" CACHE STRING "Root of the target development environment (libraries, headers etc).")
